package com.easymock;//package easymock.first.test;
...
public class IncomeCalculatorTest {
    ...
    public void testCalc1() {
        ...
        expect(calcMethod.calc(Position.EMPLOYEE)).andReturn(50000.0);
